...
public class SimpleTests {
	public static void main(String args[]) {
		...
		game.endShot(); // this adds inning and switches player
		
		//strikeCORRECT + endShot -> no score -> changePLAYER ++inning
		...
		// foul = no score + changePLAYER ++inning
		...
		//strikeWRONG = foul = no score + changePLAYER ++ inning
		...
		//what happens if the player dont hit anything
		// why is he still playing even though he failed a shot
		
		//endSHOT + NOSTRIKE = NO WORK  
